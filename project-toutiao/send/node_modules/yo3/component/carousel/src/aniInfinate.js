...
exports.default = function () {
    ...
    var obj = {
        ...
        touchmove: function touchmove(aniObj) {
            ...
            var k = this._caculateTranslate(aniObj, touchstartLocation[0] - touchmoveLocation[0]);
            var change = k / unit + (pageNow - 1);
        ...
        _caculateTranslate: function _caculateTranslate(_ref2, x) {
            var loop = _ref2.loop,
